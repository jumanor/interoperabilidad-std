...
CREATE TABLE ESQ_IOTRAMITE.IOTDTC_RECEPCION (
                SIDRECEXT int4 DEFAULT nextval('ESQ_IOTRAMITE.NU_INT_DOC_REC'::regclass) NOT NULL ,
                ...
                CONSTRAINT UNIQUE_VCUOREF_RECEPCION UNIQUE (VCUOREF),
...
CREATE TABLE ESQ_IOTRAMITE.IOTDTC_DESPACHO (
                SIDEMIEXT int4 DEFAULT nextval('ESQ_IOTRAMITE.NU_INT_DES_EXT'::regclass) NOT NULL ,
                VNUMREGSTD VARCHAR(14),
                VANIOREGSTD VARCHAR(4),
                CTIPDOCIDEREM CHAR(1) NOT NULL,
                VNUMDOCIDEREM VARCHAR(9) NOT NULL,
                ...
                CONSTRAINT UNIQUE_VCUOREF_DESPACHO UNIQUE (VCUOREF),
...
CREATE TABLE ESQ_IOTRAMITE.IOTDTM_DOC_EXTERNO (
                SIDDOCEXT int4 DEFAULT nextval('ESQ_IOTRAMITE.NU_INT_DOC_EXT'::regclass) NOT NULL ,
...
CREATE TABLE ESQ_IOTRAMITE.IOTDTD_DOC_PRINCIPAL (
                SIDDOCPRI int4 DEFAULT nextval('ESQ_IOTRAMITE.NU_INT_DOC_PRI'::regclass) NOT NULL ,
                SIDDOCEXT int4 NOT NULL,
...
CREATE TABLE ESQ_IOTRAMITE.IOTDTD_ANEXO (
                SIDDOCANX int4 DEFAULT nextval('ESQ_IOTRAMITE.NU_INT_ANX'::regclass) NOT NULL ,
